...
namespace QuanLyBanTraGopXeHonda.Forms
{
    public partial class KhachHang : Form
    {
        ...
        public KhachHang() { InitializeComponent(); }
        ...
        private void frmKhachHang_Load(object sender, EventArgs e)
        {
            ...
            // Prevent DataGridView from auto-creating columns and ensure a single set of columns
            dataGridView1.AutoGenerateColumns = false;
            dataGridView1.Columns.Clear();

            // Define the columns once (DataPropertyName must match entity property names)
            dataGridView1.Columns.Add(new DataGridViewTextBoxColumn { Name = "ID", DataPropertyName = "ID", HeaderText = "ID" });
            dataGridView1.Columns.Add(new DataGridViewTextBoxColumn { Name = "HoVaTen", DataPropertyName = "HoVaTen", HeaderText = "Họ và tên" });
            dataGridView1.Columns.Add(new DataGridViewTextBoxColumn { Name = "CCCD", DataPropertyName = "CCCD", HeaderText = "CCCD" });
            dataGridView1.Columns.Add(new DataGridViewTextBoxColumn { Name = "DienThoai", DataPropertyName = "DienThoai", HeaderText = "Điện thoại" });
            dataGridView1.Columns.Add(new DataGridViewTextBoxColumn { Name = "DiaChi", DataPropertyName = "DiaChi", HeaderText = "Địa chỉ" });
        ...
        private void BtnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (row?.DataBoundItem is QuanLyBanTraGopXeHonda.Data.KhachHang selected)
            {
                if (MessageBox.Show("Xác nhận xóa khách hàng?", "Xóa", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    if (kh != null) { context.KhachHangs.Remove(kh); context.SaveChanges(); }
